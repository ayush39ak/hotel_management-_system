        ...
        row.innerHTML = `
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <span class="px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800">
                    ${this.getBookingTypeText(booking.bookingType)}
                </span>
            ...
            <td class="px-6 py-4 whitespace-nowrap">
                <span class="px-2 py-1 text-xs font-medium rounded-full payment-${booking.paymentStatus}">
                    ${this.getPaymentStatusText(booking.paymentStatus)}
                </span>
            </td>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <div>
                    <div class="font-semibold">$${booking.totalAmount}</div>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                ...
                ${(checkinInfo || bookingCheckinInfo) ? 
                    `<button onclick="bookingsManager.viewCheckinDetails(${booking.id})" 
                            class="text-green-600 hover:text-green-900 mr-3">Check-in</button>` : ''}
